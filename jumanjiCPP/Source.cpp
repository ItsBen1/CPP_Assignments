/*
    ...
    Assignment Name: Text Adventure Game - Late Night Racer
*/

// Late Night Racer 
// A choice driven racing game!

//These bring in the iostream for console readout as well as string to use strings.
#include <iostream>
#include <string>
// The next two lines make it so I can underline important words

//I decided to bring in the entire std namespace so I don't forget to include any objects while I am coding to prevent an error.
using namespace std;

    int main() {
        //Setup Variables - used for starting speed as well as getting names from users.
        int speed = 100;
        string racer;
        string rival;
    ...
    gameStart:
        cout << "\n------------------------------------\n\n";
        cout << "Welcome to Midnight Racer by Donald Christensen\n\n";
        cout << "The game will change depending on the choices you make.\n";
        cout << "You will start at 100% speed. Depending on the actions you make, you will either speed up or slow down as the couse countinues.\n";
        cout << "Have fun and good luck!\n\n";
        cout << "------------------------------------\n";
        system("pause"); // Pause to make sure the player is ready to play. Similar to a "Click start to start game".
    ...
    cout << "Enter your Opponites Name:"; // Used for rival player - the player's opponent. Not a CPU in this case.
    cin >> rival; // User input.

    // Dialogue for player.
    cout << "\nWelcome all to tonights race!\n";
    cout << "We have some tough challengers tonight, so lets not waste any more time!\n";
    ...
    cout << "Tonights race will put each racer's skills to the test. Both racers will compete head-to-head in a race from the South end of Night City to the North end.\n";
    cout << "Without further ado, lets burn some rubber and get racing!\n\n";
...
engine: // Anchor point to be able to come back to this point. Used multiple anchor points throughout code.
    ...
    if (start == "start" || start == "Start") { // First "if" statement. Basically if the player types "start" or "Start", the game will continue. 
        cout << "\nGood work!\n";
        goto begin;
    }
...
begin: // Another anchor point.
    ...
    cout << "Quick! Type start to restart your engine in time!\n\n";
    cin >> start; // User input.
...
engineStallContinue: // Another anchor point.
    ...
    // The Crowd Scenario
    cout << "\nAfter some time racing through the downtown of Night City, you catch back up with " << rival << ".\n";
    cout << "But as soon as you are neck-and-neck with " << rival << ", they drive through a crowd of night gowers pushing them into your path.\n";
    cout << "You see a shortcut down an alley, but its risky as you cannot see where it will take you.\n";
    cout << "\nDo you take the shortcut and try and speed up, or do you drive straight through the busy street full of people?\n";
    cout << "Type shortcut to take the shortcut. Type straight to drive through the crowd.\n\n";
    cin >> nightGowers; // User input.
    if (nightGowers == "shortcut" || nightGowers == "Shortcut") { // If player types shortcut, then player speeds up 10% and game continues.
        ...
        goto nightGowersContinue;
    }
    if (nightGowers == "straight" || nightGowers == "Straight") { // If player types straight, player doesn't lose or gain any speed and game continues.
        cout << "\nYou went straight through the crowd. Thankfully they move out of the way as you come hurtling towards them, you wind up slightly behind " << rival << ". You didn't lose any speed, but you didn't gain any either. You now have " << speed - 10 << " % speed.\n";
        goto nightGowersContinue;
    }
...
nightGowersContinue: // Another anchor point.

    // Crowded Street Scenario
    cout << "\nEntering uptown Night City, the roads seem to be busier than expected. " << rival << " takes a sharp right and turn down an alley way to get around all of the street vendors.\n";
    ...
    cin >> busyStreet; // User input.
    if (busyStreet == "street" || busyStreet == "Street") { // If player types street, player loses 35% speed and game continues.
        ...
        goto crowdedStreetContinue;
    }
    if (busyStreet == "highway" || busyStreet == "Highway") { // If player types highway, player gains 15% speed and game continues.
...
crowdedStreetContinue: // Another anchor point.
...
brokenBridgeContinue: // Another anchor point.
    ...
    /*
        ...
        I also wanted to be able to use the speed variable but everything I tried kept giving me errors. Only way to make the ending part possible was with if and else.
    */
