...
Assignment Name : Interactive Simulation & Functions - Street Driver
*/
...
void opening() {
    cout << "\n------------------------------------\n\n";
    cout << "Welcome to Night Racer by Virgilian Lacy\n\n";
...
string playGame() {
    ...
    //If the player types "alley" or "Alley", they go down one path. If they type "straight" or "Straight", then they go down the other path. If they do not type either, then they lose.
    ...
    cout << "Type street to take the crowded streets or type beach to turn towards the beach.\n\n"; \
        ...
        //If the player types "street" or "Street", they go down one path. If they type "beach" or "Beach", then they go down the other path. If they do not type either, then they lose.
