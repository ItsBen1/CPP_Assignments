// randomProfessorGenorator.cpp : This file contains the 'main' function. Program execution begins and ends there.
//

/*
	Author: Virgilian Lacy
	Email: virlacy@uat.edu
	Assignment Name: Random Numbers, Arrays, and Sound in C++ Part I and II
*/
...
// There is also a Windows API for the beep sound. Not totally necessary but it allows for the programmer to be able to adjust the sound as well as the length of sound.
#include <iostream>
#include <algorithm>
#include <string>
#include <windows.h>
...
// Arrays for the professors, and the rooms.
string profArray[20] = { "Heather Peters","Sharon Bolman","Ronald Zabawa","David Brokaw","Daniel Pike","Steven Cofrancesco","Nathan Glover","Alan Hromas","Kendra Kim","Craig Belanger",
...
gameStart: // Start of the game anchor for the restart function.
	printf("\n------------------------------------\n\n");
	printf("Welcome to the UAT classroom tour by Virgilian Lacy\n\n");
	printf("There are 20 different classrooms and 10 different professors to see today.\n");
	printf("Your job is to choose a room in which a professor is located.\n");
	...
	printf("\nHello! Thanks for coming into UAT!\n");
	printf("We have a handful of rooms to visit today.\n");
	printf("If your ready lets get started, now follow me. \n");
