...
Assignment: Code Breaker Training Simulation - Keywords II
*/
...
void opening() {
	...
	cout << "Your assignment, if you choose to accept it, is to guess the randomly chosen word before you run out of guesses.\n";
